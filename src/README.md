...
icon: house
title: 首页
heroImage: /assets/image/logo.ico
bgImage: https://theme-hope-assets.vuejs.press/bg/6-light.svg
bgImageDark: https://theme-hope-assets.vuejs.press/bg/6-dark.svg
bgImageStyle:
  background-attachment: fixed
heroText: 轨道编辑器
tagline: 一款简洁设计、高效执行的自动化软件。
actions:
  - text: 使用手册
    icon: lightbulb
    link: ./demo/
...
highlights:
  - header: 安装便捷
    ...
    highlights:
      - title: 在交流群文件中下载“轨道编辑器.exe”运行即可，安装路径为您运行位置。
      - title: 若提示缺少dll问题请在交流群中下载“dll修复工具”。

  - header: 强大的执行器
    image: /assets/image/logo2.ico
