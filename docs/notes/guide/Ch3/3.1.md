...
<tbody>
  <tr>
    <td rowspan="12"><img src="./images/3.1.1.1.png" 
...
1. 点击<img src="./images/3.1.2.1.png" alt="" width="64" height="25">可隐藏执行器，再次运行“轨道执行器.exe”恢复界面。
2. 点击<img src="./images/3.1.2.2.png" alt="" width="64" height="25">可一键打包所需截图和日志，方便上传至交流群提问/报错。<span style="color: red;">执行时遇到问题请上传报错信息，单纯提问（如“为什么不放卡”）很难确定问题的原因。</span>
...
<tbody>
  <tr>
    ...
    <td rowspan="5"><img src="./images/3.1.2.5.png" 
      style="vertical-align: middle; "
    ></td>
  </tr>
...
<img src="./images/3.1.4.1.png" alt="" width="363" height="250">  <img src="./images/3.1.4.2.png" alt="" width="363" height="250"> 
...
- 点击执行器右侧的 <img src="./images/3.1.4.3.png" alt="" width="77" height="25"> 可设置<span style="color: red;">全体任务</span>的开局加速时间，优先级低于加速指令。
