...
export default defineThemeConfig({
  ...
  footer: {
    ...
    copyright: `Copyright © 2025-${new Date().getFullYear()} ちまめ <br> <span class="beian-links"> <img alt="备案编号图标" src="/Track-Web/beian.png" width="20"> <a href="https://beian.mps.gov.cn/#/query/webSearch?code=43010402002137" rel="noreferrer" target="_blank">湘公网安备43010402002137号</a> <a href="https://beian.miit.gov.cn/" target="_blank">湘ICP备2025113886号-1</a> </span>`,
  },
